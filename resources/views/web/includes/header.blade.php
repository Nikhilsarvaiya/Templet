<header class="header {{ request()->routeIs('web.home')!='web.home' ? 'header_inner_page' : 'header_inner_page' }} ">
    @if(request()->routeIs('web.home')!='web.home' || request()->routeIs('web.home')=='web.home')
                ...
                <div class="wrapper_menu">
                    <div class="header-item-left">
                        <a href="{{ Route('web.home') }}" class="brand">
                            <img src="{{ request()->routeIs('web.home')!='web.home' ? asset('assets/user/images/inner_logo.png') : asset('assets/user/images/inner_logo.png') }}" alt="img">
                        </a>
                    </div>
                    <!-- Section: Navbar Menu -->
                    <div class="header-item-center">
                        ...
                        <nav class="menu">
                            ...
                            <ul class="menu-section">
                                ...
                                <li class="{{ request()->routeIs('web.pooja.bookings') ? 'active' : ''}} "><a href="{{ Route('web.pooja.bookings') }}">Pooja Bookings</a></li>
                                <li><a href="javascript:;">Donate</a></li>
                                <li class="{{ request()->routeIs('web.programs') ? 'active' : ''}} "><a href="{{ Route('web.programs') }}">Programs</a></li>
