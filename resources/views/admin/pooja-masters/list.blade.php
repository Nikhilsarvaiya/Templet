...
@section('title', 'Pooja Masters')
@section('content')
<!-- begin:: Subheader -->
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">Pooja Masters</h3>
            ...
            <div class="kt-portlet__head-toolbar">
                    ...
                    <div class="kt-portlet__head-actions">
                        &nbsp;
                            ...
                            <a href="{{ route('admin.pooja.masters.add') }}" class="btn btn-brand btn-elevate btn-icon-sm" id="add-faq-form-modal">
...
@push('script')
    <script>
        ...
        makeDataTable('#faq_list_table', "{{ route('admin.pooja.masters.list') }}", conf)
    </script>
@endpush