        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                    ...
                    <div class="kt-portlet__head-actions">
                        &nbsp;
                        @can('role-create')
                            <a href="{{ route('roles.create') }}" class="btn btn-brand btn-elevate btn-icon-sm" id="add-service-form-modal">
                ...
                <tbody>
                    @foreach ($roles as $key => $role)
                        <tr>
                            <td>{{ $role->name }}</td>
                            <td>
                            <a class="btn btn-icon btn-outline-info btn-sm" data-container="body" data-toggle="kt-tooltip" data-placement="top" title="" data-original-title="Show detail" href="{{ route('roles.show',$role->id) }}"><i class="la la-info"></i></a>
                            @can('role-edit')
                                <a class="btn btn-icon btn-outline-brand btn-sm" href="{{ route('roles.edit',$role->id) }}"><i class="la la-edit"></i></a>
                            @endcan
                            @can('role-delete')
