...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__breadcrumbs">
            <a href="{{ route('roles.index') }}" class="kt-subheader__breadcrumbs-home"><i class="fa fa-arrow-left"></i></a>
        </div>
    </div>
</div>
<!-- end:: Subheader -->
...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <!--begin::Portlet-->
        <!--begin::Form-->
        <form class="kt-form" action="{{ route('roles.store') }}" enctype="multipart/form-data" id="service-add-from" method="post" >
