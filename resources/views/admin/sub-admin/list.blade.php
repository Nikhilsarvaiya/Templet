...
@section('content')
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Sub admin management</h3>
                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            @can('sub-admin-create')
                                <a href="{{ route('admin.sub-admin.add') }}" class="btn btn-brand btn-elevate btn-icon-sm"
...
@push('script')
    <script>
        ...
        makeDataTable('#admin_list_table', "{{ route('admin.sub-admin.getList') }}", conf)
    </script>
@endpush
