                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-widget17">
                            <div class="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides"
                                ...
                                <div class="kt-widget17__chart" style="height:5px;">
                                    {{-- <canvas id="kt_chart_activities"></canvas> --}}
                                </div>
                            </div>
                            <div class="kt-widget17__stats kt-widget17__stats_new">
                                <div class="kt-widget17__items">
                                    ...
                                    <div class="kt-widget17__item">
                                        <a href="{{ route('admin.user.contact.us.list') }}">
                                            <span class="kt-widget17__icon">
                                                <i class="icon-sub_admin"></i>
                                            </span>
                                            <span class="kt-widget17__subtitle">
                                                User Inquiry
                                            </span>
                                            <span class="kt-widget17__desc">
                                                {{ $user_inquiry }} Total User Inquiries
                                            </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="kt-widget17__items">
                                    <div class="kt-widget17__item">
                                        <a href="{{ route('admin.pooja.masters.list') }}">
                                            <span class="kt-widget17__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <polygon id="Bound" points="0 0 24 0 24 24 0 24" />
                                            ...
                                            <span class="kt-widget17__desc">
                                                {{ $poojaMasters }} Total Pooja Masters
                                            </span>
                                        </a>
                                    </div>
                                    <div class="kt-widget17__item">
                                        <a href="{{ route('admin.panditji.availabilities.list') }}">
                                            <span class="kt-widget17__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <polygon id="Bound" points="0 0 24 0 24 24 0 24" />
                                            ...
                                            <span class="kt-widget17__desc">
                                                {{ $panditjiAvailabilities }} Total Panditji Availabilities
                                            </span>
                                        </a>
                                    </div>
                                    <div class="kt-widget17__item">
                                        <a href="{{ route('admin.pooja.creations.list') }}">
                                            <span class="kt-widget17__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <polygon id="Bound" points="0 0 24 0 24 24 0 24" />
                                            ...
                                            <span class="kt-widget17__desc">
                                                {{ $poojaCreations }} Total Pooja Creations
                                            </span>
                                        </a>
                                    </div>
                                    <div class="kt-widget17__item">
                                        <a href="{{ route('admin.customer.pooja.bookings.list') }}">
                                            <span class="kt-widget17__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <polygon id="Bound" points="0 0 24 0 24 24 0 24" />
                                            ...
                                            <span class="kt-widget17__desc">
                                                {{ $customerPoojaBookings }} Total Customer Pooja Bookings
                                            </span>
                                        </a>
                                    </div>
                                </div>
